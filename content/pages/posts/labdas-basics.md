...
When we have a lambda that is just performing a direct method call, we can use a more compact syntax available: a method reference. For example, the lambda
