...
The only case that you might want to no use a method reference is when we are dealing with a method which the full name is longer than the lambda. For example
